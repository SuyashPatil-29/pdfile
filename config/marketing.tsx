import { Book, Code, File, Globe, } from "lucide-react";
import { SiOpenai } from "react-icons/si";

export const mission = `
At PDFILE our mission is to use AI to make studying easier and efficient rather than using AI to replace studying altogether. 
If you need to create a quiz or flashcards and all you have is a zoom recording of a lecture, or a pdf file of notes, or a link to a website, PDFILE can help!
`;

export const featuresPara = `
PDFILE includes many different features like file uploading and
